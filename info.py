...
API_ID = int(environ.get('API_ID', '27059887'))
API_HASH = environ.get('API_HASH', 'd8b8053de3295570c84ce32b47e9e09e')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002278220928'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7006876826').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002371692699').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001471513979') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://kfyiez8:9lQmz3LVGmxYvRcH@cluster0.vdir5.mongodb.net/?retryWrites=true&w=majority")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/cc_new_movie')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/cc_new_movie')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/cctuitorial')
...
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/cctuitorial')
